...
def weissinger_l(wing,alpha_root, m): 
    """  https://github.com/montagdude/weissinger 
    
    Method for a swept, tapered, twisted wing.

    :param wing: SingleWing data structure
    :type wing: SingleWing
    :param alpha_root: angle of attack at the root in radians
    :type alpha_root: float, (radians)
    :param m:  number points along the span (an odd number)
    :type m: Integer odd
    :return: 
